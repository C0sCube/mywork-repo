...
from app.program_logger import create_logger, setup_session_logger
from app.registry_sid import SID_CLASS_REGISTRY
...
watch_logger = create_logger("watcher", log_dir=DAILY_LOG_DIR,log_level=logging.WARNING)
